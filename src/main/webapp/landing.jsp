            ...
            <header class="header">
                ...
                <div class="header-bottom">
                    ...
                    <div class="header-bottom__col col-img">
                        <img src="./assets/img/header_pic.jpeg" alt="" class="width-100">
                    </div>
                </div>
            </header>
            ...
            <div class="content">
                            ...
                            <div class="section-blog__features">
                                <div class="item features__item">
                                    <div class="feature-item__img">
                                        <img src="./assets/img/7-ao-tuong-tinh-yeu.jpg" alt="" class="width-100">
                                    </div>
                                    <div class="item__description">
                                        <h2 class="item-name font-black">7 ảo tưởng tình yêu</h2>
                                        <p class="item-author font-black">Mike George</p>
                                        <p class="item-price font-black">80000 VND</p>
                                ...
                                <div class="item features__item">
                                    <div class="feature-item__img">
                                        <img src="./assets/img/TheOutsider.jpg" alt="" class="width-100">
                                    </div>
                                    <div class="item__description">
                                        <h2 class="item-name font-black">The Outsider</h2>
                                        <p class="item-author font-black">Stephen King</p>
                                        <p class="item-price font-black">125000 VND</p>
                                        <div class="feature-item__btns buy-btns">
                                            <button class="btn btn--buy btn--primary"><a href="/product.html" class="product-view no-deco">View Book</a></button>
                                            <button class="btn btn--buy btn--secondary"><a href="" class="product-view no-deco">Add to cart</a></button>
                                        </div>
                                ...
                                <div class="item features__item">
                                    <div class="feature-item__img">
                                        <img src="./assets/img/Later.jpg" alt="" class="width-100">
                                    </div>
                                    <div class="item__description">
                                        <h2 class="item-name font-black">Later</h2>
                                        <p class="item-author font-black">Stephen King</p>
                                        <p class="item-price font-black">100000 VND</p>
                                        <div class="feature-item__btns buy-btns">
                                            <button class="btn btn--buy btn--primary"><a href="/product.html" class="product-view no-deco">View Book</a></button>
                                            <button class="btn btn--buy btn--secondary"><a href="" class="product-view no-deco">Add to cart</a></button>
                                        </div>
                ...
                <div class="section section--subcategory">
                    <div class="section__container">
                        <div class="section-header">
                            <h1 class="header-item">Feature Books</h1> <!-- co the lay ten section tu database xong hien danh sach san pham thuoc category do-->
                        </div>
                        <div class="item-wrapper section__item-wrapper">
                            <div class="item">
                                <div class="item__description item--horizontal">
                                    <h2 class="item-name">Những chuyện kể của Beedle người hát rong</h2>
                                    <p class="item-author">J.K.Rowling</p>
                                    <p class="item-price">95000 VND</p>
                                </div>
                                <div class="item__img">
                                    <img src="./assets/img/sach-nhung-chuyen-ke-cua-beedle.jpg" alt="" class="width-100">
                                </div>
                            ...
                            <div class="item">
                                <div class="item__description item--horizontal">
                                    <h2 class="item-name">Tuổi trẻ đáng giá bao nhiêu</h2>
                                    <p class="item-author">Rosie Nguyễn</p>
                                    <p class="item-price">75000 VND</p>
                                </div>
                                <div class="item__img">
                                    <img src="./assets/img/TuoiTre.jpg" alt="" class="width-100">
                                </div>
                                <div class="quick-nav-modal">
                                    <button class="btn btn--slide-down"><a href="/product.html" class="product-view no-deco">View Item</a></button>
                                    <button class="btn btn--slide-up"><a href="" class="add-to-cart no-deco"><i class="fas fa-cart-plus"></i> Add to cart</i></a></button>
